                                        ...
                                        <form method="post" action="{{ route('player-form.store') }}" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="input-field col s12">
                                                    <p for="name_en">Add Player Name EN * </p>
                                                ...
                                                <div class="input-field col s12">
                                                    <p for="name_ar">Add Player Name AR * </p>
                                                    <input id="name_ar" name="name_ar" type="text"  required data-error=".errorTxt7">
                                                ...
                                                <div class="input-field col s12">
                                                    <p for="description_en">Add Player Description EN * </p>
                                                    <input id="description_en" name="description_en" type="text"  required data-error=".errorTxt2">
                                                ...
                                                <div class="input-field col s12">
                                                    <p for="description_ar">Add Player Description AR * </p>
                                                    <input id="description_ar" name="description_ar" type="text"  required data-error=".errorTxt8">
                                                ...
                                                <div class="input-field col s12">
                                                    ...
                                                    <input id="player_sorting" name="player_sorting" type="number" min="1" >
                                                </div>
