...
{{--                                                    <td>{{ $subscriptionplan->lang }}</td>--}}
                                                    <td>
                                                        <a class="mb-5 btn waves-effect waves-light gradient-45deg-purple-deep-orange" href="{{ route('subscriptionplans.show',[ 'subscriptionplan' => $subscriptionplan->id ]) }}">{{ __('customer.show') }}</a>
