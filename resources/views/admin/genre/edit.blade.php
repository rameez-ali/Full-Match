                                ...
                                <div class="card-content">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="row">
                                          ...
                                          <input type="text" name="name_en" id="name_en" maxlength="16" value="{{ $genre->name_en }}" class="form-control input-lg" data-error=".errorTxt1" required />
                                         ...
                                         @enderror
                                            ...
                                            <div class="input-field col s12">
                                                ...
                                                <input type="text" name="name_ar" id="name_ar" maxlength="16" value="{{ $genre->name_ar }}" class="form-control input-lg" data-error=".errorTxt1" required />
                                                <small class="errorTxt1"></small>
                                                @error('name_ar')
                                                <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
