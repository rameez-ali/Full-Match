                                    ...
                                    <div class="row">
                                        <div class="col s12">
                                            ...
                                            <table id="page-length-option" class="display">
                                                <thead>
                                                <tr>
                                                 <th width="27%">League Name</th>
                                                 <th width="27%">League Description</th>
                                                 <th width="27%">League Banner</th>
                                                 <th width="27%">League Promo Video</th>
                                                 <th width="27%">See Details</th>
                                                 ...
                                                 <tr>
                <!-- <td><img src="{{ URL::to('/') }}/images/{{ $project->project_image }}"  class="img-thumbnail" width="75" /></td> -->
                                                <td>{{ $project->League_Name   }}</td>
                                                <td>{{ $project->League_Description }}</td>
                                                <td>{{ $project->league_banner }}</td>
