        ...
        <h1 class="logo-wrapper"><a class="brand-logo darken-1" href="{{ route('dashboard') }}"><img class="hide-on-med-and-down " src={{ asset('app-assets/images/logo/fm-logo.png') }} alt="materializelogo" /><img class="show-on-medium-and-down hide-on-med-and-up" src={{ asset('app-assets/images/logo/fm-logo.png') }} alt="materializelogo" /><span class="logo-text hide-on-med-and-down">Full Match</span></a><a class="navbar-toggler" href="#"><i class="material-icons">radio_button_checked</i></a></h1>
          ...
          @php
              $menu = [
                    ...
                    [  'icon' => 'add_location' , 'label'  => 'Contact Us' , 'route' => 'Contactus-form.index' , 'children' => [], 'permission' => 'view-category' ],
                    [  'icon' => 'question_answer' , 'label'  => 'Contact Queries' , 'route' => 'contact-form.index' , 'children' => [], 'permission' => 'view-category' ],
                    [  'icon' => 'domain' , 'label'  => 'Category' , 'route' => 'category-form.index' , 'children' => [], 'permission' => 'view-category' ],
                    [  'icon' => 'video_library' , 'label'  => 'Genre' , 'route' => 'genre-form.index' , 'children' => [], 'permission' => 'view-category' ],
                    [  'icon' => 'border_all' , 'label'  => 'Club' , 'route' => 'club-form.index' , 'children' => [], 'permission' => 'view-category' ],
                    [  'icon' => 'directions_walk' , 'label'  => 'Player' , 'route' => 'player-form.index' , 'children' => [], 'permission' => 'view-category' ],
                    [  'icon' => 'event' , 'label'  => 'League' , 'route' => 'league-form.index' , 'children' => [], 'permission' => 'view-category' ],
                    [  'icon' => 'ondemand_video' , 'label'  => 'Video' , 'route' => 'video-form.index' , 'children' => [], 'permission' => 'view-category' ],
