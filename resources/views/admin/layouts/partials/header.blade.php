...
{{--                    <li class="dropdown-item"><a class="grey-text text-darken-1" href="{{ url('setlocale/en') }}" data-language="en"><i class="flag-icon flag-icon-gb"></i> English </a></li>--}}
{{--                    @else--}}
{{--                    <li class="dropdown-item"><a class="grey-text text-darken-1" href="{{ url('setlocale/ar') }}" data-language="fr"><i class="flag-icon flag-icon-ae"></i>{{ trans('text.lang_selector') }} </a></li>--}}
{{--                    @endif--}}
                ...
                <ul class="dropdown-content" id="profile-dropdown">
                    ...
                    <li class="divider"></li>
                    <li><a class="grey-text text-darken-1" href="{{ route('customer.logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i class="material-icons">keyboard_tab</i>{{ __('Logout') }}</a></li>
